...
export default function PreferencesPage() {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-8 space-y-8 select-none">
      ...
      <div>
        <h1 className="text-xl font-bold tracking-tight font-heading text-foreground">Marketplace Preferences</h1>
        <p className="text-xs text-muted-foreground mt-1">Configure default currencies or language settings.</p>
      </div>
